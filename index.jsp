...
<body>
 ...
 <form action="indexFormAction.jsp" method="post" autocomplete="off">
 <center>
  <input type="text" name="name" placeholder="Enter your name" required>
  <input type="text" name="mobilenumber" placeholder="Enter your mobile no" required>
...
<h3><center>Developed By:Rajan Jayswal  </center></h3>
